            ...
            <div className="bg-red-700 md:w-[60%] w-[90%] my-10 flex items-center justify-center rounded-2xl shadow-lg">
                ...
                <div className="bg-black p-7 md:p-4 w-full rounded-2xl md:rounded-l-none">
                    ...
                    <form className="pb-5" action="">
                        ...
                        <input className="w-full mb-3 border border-2 border-black rounded-md p-2" placeholder="john.doe@example.com" type="email" name="email" id="email" />
                        <label className="block text-lg text-white" id="password" htmlFor="">Password:</label>
                        <input className="block w-full mb-3 border border-2 border-black rounded-md p-2" placeholder="Password" type="password" name="password" id="password" />
                        <input className="mb-3 mr-2" type="checkbox" name="remember" id="remember" />
                        ...
                        <Link href=""className="bg-black rounded-md  px-3 py-1 mb-7 block w-full text-white text-lg border-2 border-white hover:text-black hover:bg-white" type="submit">Register</Link>
                    </form>
                </div>
            </div>
        </div>
